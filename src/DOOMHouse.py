...
class DOOMHouse:
    ...
    def render(self):
        try:
            ...
            line1 = f"Insert: {self.insert_time:3.2f}ms (avg: {self.avg_insert_time:3.2f}ms) | Select: {select_time:3.2f}ms (avg: {avg_select_time:3.2f}ms) | {fps:2.1f}fps (avg: {avgfps:2.1f}fps)"
